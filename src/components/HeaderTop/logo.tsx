 ...
 * @LastEditTime: 2024-08-25 16:43:24
...
const HeaderLogo: React.FC = () => {
  ...
  return <div className="HeaderLogo w-[226px] h-[32px] md:w-[290px] md:h-[40px] lg:w-[290px] lg:h-[40px]">
      <div className="w-[226px] h-[32px] md:w-[290px] md:h-[40px] lg:w-[290px] lg:h-[40px] bg-[url('@/assets/images/logo.svg')] bg-no-repeat bg-cover bg-center ">
      </div>
  </div>;
}
